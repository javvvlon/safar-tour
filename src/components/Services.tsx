...
const services = [
    {
        icon: Plane,
        title: "Aviachiptalar",
        description: "Eng yaxshi narxlarda aviachiptalarni bron qiling",
    },
    {
        icon: Hotel,
        title: "Mehmonxonalar",
        description: "Dunyo bo'ylab eng yaxshi mehmonxonalarni tanlang",
    },
    {
        icon: MapPin,
        title: "Ekskursiyalar",
        description: "Professional gidlar bilan qiziqarli sayohatlar",
    },
    {
        icon: Headphones,
        title: "24/7 Yordam",
    ...
    },
    {
        icon: CreditCard,
        title: "Qulay to'lov",
        description: "Naqd va plastik kartalar orqali to'lov",
    },
    {
        icon: Shield,
        title: "Sug'urta",
        description: "Sayohat sug'urtasi bilan xavfsiz dam oling",
    },
];
...
const Services = () => {
    return (
        <section id="xizmatlar" className="py-24 bg-muted/30 relative overflow-hidden">
            {/* Decorative Elements */}
          ...
          <span className="inline-block px-4 py-2 bg-primary/10 text-primary rounded-full text-sm font-medium mb-4">
            Xizmatlarimiz
                    ...
                    <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
                        Safar Travel sizga sayohatingizni oson va qulaylashtirish uchun
                        keng qamrovli xizmatlarni taqdim etadi
                    </p>
                </motion.div>
